...
void Visualiser::addPointCloud(const std::string &id,RGB rgb,pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud){
...
void Visualiser::updatePointCloud(const std::string &id,RGB rgb,pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud){
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> color(cloud, rgb.red,rgb.green, rgb.blue);
